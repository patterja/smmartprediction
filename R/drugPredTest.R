...
drugPredTest<- function(path_to_bcclsmmart,
  ...
  JWGray_RNASeq <- JWGray_RNASeq[, grepl("ACXX|AAXX", colnames(JWGray_RNASeq))]
  ...
  SMMART_RNASeq = SMMART_RNASeq[, !grepl("ACXX|AAXX", colnames(SMMART_RNASeq))]
  SMMART_RNASeq = SMMART_RNASeq[, !grepl("RNA170328LH|RNA170329LH|^X170322_NS500642", colnames(SMMART_RNASeq))]
